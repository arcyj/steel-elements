<?php
namespace WilmerCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'wilmer-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'wilmer-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'wilmer-core' ),
							'value'      => array(
								esc_html__( '80/20', 'wilmer-core' ) => '80',
								esc_html__( '75/25', 'wilmer-core' ) => '75',
								esc_html__( '66/33', 'wilmer-core' ) => '66',
								esc_html__( '50/50', 'wilmer-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px)', 'wilmer-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Button Type', 'wilmer-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'wilmer-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Color', 'wilmer-core' ),
							'group'      => esc_html__( 'Button Style', 'wilmer-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Button Border Color', 'wilmer-core' ),
							'group'      => esc_html__( 'Button Style', 'wilmer-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'wilmer-core' ),
							'group'      => esc_html__( 'Button Style', 'wilmer-core' )
						),
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'wilmer-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'wilmer-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = wilmer_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
