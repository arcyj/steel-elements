<?php
namespace WilmerCore\CPT\Shortcodes\SectionTitle;
...
class SectionTitle implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Section Title', 'wilmer-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Two Columns', 'wilmer-core' ) => 'two-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Title - Text Position', 'wilmer-core' ),
							'value'       => array(
								esc_html__( 'Title Left - Text Right', 'wilmer-core' ) => 'title-left',
								esc_html__( 'Title Right - Text Left', 'wilmer-core' ) => 'title-right'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Space Between Columns', 'wilmer-core' ),
							'value'       => array(
								esc_html__( 'Normal', 'wilmer-core' ) => 'normal',
								esc_html__( 'Small', 'wilmer-core' )  => 'small',
								esc_html__( 'Tiny', 'wilmer-core' )   => 'tiny'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'two-columns' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'position',
							'heading'     => esc_html__( 'Horizontal Position', 'wilmer-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Holder Side Padding (px or %)', 'wilmer-core' )
						),
                        array(
                            'type'        => 'textfield',
                            'param_name'  => 'intro_title',
                            'heading'     => esc_html__( 'Intro Title', 'wilmer-core' ),
                            'description' => esc_html__('Intro text which will be placed before section title')
                        ),
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'intro_title_tag',
                            'heading'     => esc_html__( 'Intro Title Tag', 'wilmer-core' ),
                            'value'       => array_flip( wilmer_mikado_get_title_tag( true ) ),
                            'dependency'  => array( 'element' => 'intro_title', 'not_empty' => true )
                        ),
                        array(
                            'type'       => 'colorpicker',
                            'param_name' => 'intro_title_color',
                            'heading'    => esc_html__( 'Intro Title Color', 'wilmer-core' ),
                            'dependency' => array( 'element' => 'title', 'not_empty' => true ),
                            'group'      => esc_html__( 'Title Style', 'wilmer-core' )
                        ),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title',
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Bold Font Weight', 'wilmer-core' ),
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_tag',
							'heading'     => esc_html__( 'Text Tag', 'wilmer-core' ),
							'value'       => array_flip( wilmer_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'text', 'not_empty' => true ),
							'group'       => esc_html__( 'Text Style', 'wilmer-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Text Font Size (px)', 'wilmer-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true ),
							'group'      => esc_html__( 'Text Style', 'wilmer-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Text Line Height (px)', 'wilmer-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true ),
							'group'      => esc_html__( 'Text Style', 'wilmer-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Text Font Weight', 'wilmer-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = wilmer_core_get_shortcode_module_template_part( 'templates/section-title', 'section-title', '', $params );
