<?php
namespace WilmerCore\CPT\Shortcodes\PieChart;
...
class PieChart implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Pie Chart', 'wilmer-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
                        ...
                        array(
                            ...
                            'value'       => array(
                                esc_html__( 'Text aside', 'wilmer-core' ) => 'text-aside',
                                esc_html__( 'Text below', 'wilmer-core' )    => 'text-below'
                            )
                        ),
						array(
							'type'       => 'textfield',
							'param_name' => 'percent',
							'heading'    => esc_html__( 'Percentage', 'wilmer-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'percent_color',
							'heading'    => esc_html__( 'Percentage Color', 'wilmer-core' ),
							'dependency' => array( 'element' => 'percent', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'active_color',
							'heading'    => esc_html__( 'Pie Chart Active Color', 'wilmer-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'inactive_color',
							'heading'    => esc_html__( 'Pie Chart Inactive Color', 'wilmer-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'size',
							'heading'    => esc_html__( 'Pie Chart Size (px)', 'wilmer-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
