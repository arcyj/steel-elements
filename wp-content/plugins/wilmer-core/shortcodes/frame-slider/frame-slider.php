<?php
namespace WilmerCore\CPT\Shortcodes\FrameSlider;
...
class FrameSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Frame Slider', 'wilmer-core' ),
					'base'                      => $this->base,
	...
	public function render( $atts, $content = null ) {
		...
		$html =  wilmer_core_get_shortcode_module_template_part( 'templates/frame-slider', 'frame-slider', '', $params );
