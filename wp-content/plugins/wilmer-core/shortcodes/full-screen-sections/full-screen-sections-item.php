<?php
namespace WilmerCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'wilmer-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'wilmer-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Size', 'wilmer-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'wilmer-core' )   => 'cover',
								esc_html__( 'Contain', 'wilmer-core' ) => 'contain',
								esc_html__( 'Inherit', 'wilmer-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'wilmer-core' ),
							'value'       => array(
								esc_html__( 'Default', 'wilmer-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'wilmer-core' ),
							'value'       => array(
								esc_html__( 'Default', 'wilmer-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__('Background Image for Laptops', 'wilmer-core'),
							'group'       => esc_html__('Responsiveness', 'wilmer-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'wilmer-core'),
							'group'       => esc_html__('Responsiveness', 'wilmer-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'wilmer-core'),
							'group'       => esc_html__('Responsiveness', 'wilmer-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'wilmer-core'),
							'group'       => esc_html__('Responsiveness', 'wilmer-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = wilmer_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
