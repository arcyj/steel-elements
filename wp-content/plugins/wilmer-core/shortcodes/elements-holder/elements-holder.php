...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Elements Holder', 'wilmer-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'wilmer-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Columns', 'wilmer-core' ),
							'value'       => array(
								esc_html__( '1 Column', 'wilmer-core' )  => 'one-column',
								esc_html__( '2 Columns', 'wilmer-core' ) => 'two-columns',
								esc_html__( '3 Columns', 'wilmer-core' ) => 'three-columns',
								esc_html__( '4 Columns', 'wilmer-core' ) => 'four-columns',
								esc_html__( '5 Columns', 'wilmer-core' ) => 'five-columns',
								esc_html__( '6 Columns', 'wilmer-core' ) => 'six-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Items Float Left', 'wilmer-core' ),
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Never', 'wilmer-core' )        => 'never'
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Choose Alignment In Responsive Mode', 'wilmer-core' ),
							'value'       => array(
								esc_html__( 'Default', 'wilmer-core' ) => '',
							...
							'description' => esc_html__( 'Alignment When Items are in One Column', 'wilmer-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . wilmer_mikado_get_class_attribute( $holder_classes ) . ' ' . wilmer_mikado_get_inline_attr( $holder_styles, 'style' ) . '>';
