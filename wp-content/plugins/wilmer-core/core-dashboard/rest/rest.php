...
if ( ! class_exists( 'WilmerCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class WilmerCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'wilmer_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	WilmerCoreDashboardRestAPI::get_instance();
}