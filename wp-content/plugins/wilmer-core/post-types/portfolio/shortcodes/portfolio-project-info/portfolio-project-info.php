...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'wilmer-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'wilmer-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Type', 'wilmer-core' ),
							'value'       => array(
								esc_html__( 'Title', 'wilmer-core' )          => 'title',
								esc_html__( 'Category', 'wilmer-core' )       => 'category',
								esc_html__( 'Tag', 'wilmer-core' )            => 'tag',
								esc_html__( 'Author', 'wilmer-core' )         => 'author',
								esc_html__( 'Date', 'wilmer-core' )           => 'date',
								esc_html__( 'Featured Image', 'wilmer-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'wilmer-core' ),
