<?php
if ( ! function_exists( 'wilmer_mikado_init_google_fonts_array' ) ) {
    function wilmer_mikado_init_google_fonts_array() {
        ...
        $wilmer_mikado_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'wilmer_mikado_init_google_fonts_array');
}