...
/**
 * Class WilmerInstagramHelper
 */
class WilmerInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines wilmer_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'wilmer_instagram_image_atts',
			array(
