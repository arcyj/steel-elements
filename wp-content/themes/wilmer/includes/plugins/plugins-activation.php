...
if ( ! function_exists( 'wilmer_mikado_register_required_plugins' ) ) {
	...
	function wilmer_mikado_register_required_plugins() {
		$plugins = array(
			...
			array(
				'name'               => esc_html__( 'Wilmer Instagram Feed', 'wilmer' ),
				'slug'               => 'wilmer-instagram-feed',
				'source'             => get_template_directory() . '/includes/plugins/wilmer-instagram-feed.zip',
				'version'            => '2.0.2',
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false
			...
			array(
				'name'               => esc_html__( 'Wilmer Twitter Feed', 'wilmer' ),
				'slug'               => 'wilmer-twitter-feed',
				'source'             => get_template_directory() . '/includes/plugins/wilmer-twitter-feed.zip',
				'version'            => '1.1.1',
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false
