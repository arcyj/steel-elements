...
if ( ! function_exists( 'wilmer_mikado_styles' ) ) {
	...
	function wilmer_mikado_styles() {
		...
		} else if ( file_exists( MIKADO_ROOT_DIR . '/assets/css/style_dynamic_ms_id_' . wilmer_mikado_get_multisite_blog_id() . '.css' ) && wilmer_mikado_is_css_folder_writable() && is_multisite() ) {
		...
		if ( wilmer_mikado_is_responsive_on() ) {
			...
			} else if ( file_exists( MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive_ms_id_' . wilmer_mikado_get_multisite_blog_id() . '.css' ) && wilmer_mikado_is_css_folder_writable() && is_multisite() ) {
...
if ( ! function_exists( 'wilmer_mikado_scripts' ) ) {
	...
	function wilmer_mikado_scripts() {
		...
		if ( ! empty( $google_maps_api_key ) ) {
			wp_enqueue_script( 'wilmer-mikado-google-map-api', '//maps.googleapis.com/maps/api/js?key=' . esc_attr( $google_maps_api_key ) . $google_maps_extensions, array(), false, true );
            if ( ! empty( $google_maps_extensions_array ) && is_array( $google_maps_extensions_array ) ) {
                wp_enqueue_script('geocomplete', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.geocomplete.min.js', array('jquery', 'wilmer-mikado-google-map-api'), false, true);
            }
		}
...
if ( ! function_exists( 'wilmer_mikado_get_global_variables' ) ) {
	...
	function wilmer_mikado_get_global_variables() {
		...
		wp_localize_script( 'wilmer-mikado-modules', 'mkdfGlobalVars', array(
...
if ( ! function_exists( 'wilmer_mikado_per_page_js_variables' ) ) {
	...
	function wilmer_mikado_per_page_js_variables() {
		...
		wp_localize_script( 'wilmer-mikado-modules', 'mkdfPerPageVars', array(
