...
if (! function_exists('wilmer_mikado_styles')) {
    ...
    {
        $modules_css_deps_array = apply_filters('wilmer_mikado_filter_modules_css_deps', []);
        ...
        if (wilmer_mikado_is_responsive_on()) {
            ...
            if (file_exists(MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive.css') && wilmer_mikado_is_css_folder_writable() && ! is_multisite()) {
                wp_enqueue_style('wilmer-mikado-style-dynamic-responsive', MIKADO_ASSETS_ROOT . '/css/style_dynamic_responsive.css', [], filemtime(MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive.css'));
                ...
                wp_enqueue_style('wilmer-mikado-style-dynamic-responsive', MIKADO_ASSETS_ROOT . '/css/style_dynamic_responsive_ms_id_' . wilmer_mikado_get_multisite_blog_id() . '.css', [], filemtime(MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive_ms_id_' . wilmer_mikado_get_multisite_blog_id() . '.css'));
            }
        }
    }
...
if (! function_exists('wilmer_mikado_google_fonts_styles')) {
    ...
    function wilmer_mikado_google_fonts_styles()
    {
        ...
        $fonts_array = array_diff($fonts_array, [ '-1:' . $font_weight_str ]);
        ...
        if (count($fonts_array) > 0) {
            ...
            $fonts_full_list_args = [
                'family' => urlencode($fonts_full_list),
                'subset' => urlencode($font_subset_str),
            ];

            $wilmer_mikado_global_fonts = add_query_arg($fonts_full_list_args, $protocol . '//fonts.googleapis.com/css');
            wp_enqueue_style('wilmer-mikado-google-fonts', esc_url_raw($wilmer_mikado_global_fonts), [], '1.0.0');
        } else {
...
if (! function_exists('wilmer_mikado_scripts')) {
    ...
    function wilmer_mikado_scripts()
    {
        ...
        wp_enqueue_script('appear', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.appear.js', [ 'jquery' ], false, true);
        wp_enqueue_script('modernizr', MIKADO_ASSETS_ROOT . '/js/modules/plugins/modernizr.min.js', [ 'jquery' ], false, true);
        wp_enqueue_script('hoverIntent', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.hoverIntent.min.js', [ 'jquery' ], false, true);
        wp_enqueue_script('jquery-plugin', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.plugin.js', [ 'jquery' ], false, true);
        wp_enqueue_script('owl-carousel', MIKADO_ASSETS_ROOT . '/js/modules/plugins/owl.carousel.min.js', [ 'jquery' ], false, true);
        wp_enqueue_script('waypoints', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.waypoints.min.js', [ 'jquery' ], false, true);
        wp_enqueue_script('fluidvids', MIKADO_ASSETS_ROOT . '/js/modules/plugins/fluidvids.min.js', [ 'jquery' ], false, true);
        wp_enqueue_script('perfect-scrollbar', MIKADO_ASSETS_ROOT . '/js/modules/plugins/perfect-scrollbar.jquery.min.js', [ 'jquery' ], false, true);
        wp_enqueue_script('ScrollToPlugin', MIKADO_ASSETS_ROOT . '/js/modules/plugins/ScrollToPlugin.min.js', [ 'jquery' ], false, true);
        wp_enqueue_script('parallax', MIKADO_ASSETS_ROOT . '/js/modules/plugins/parallax.min.js', [ 'jquery' ], false, true);
        wp_enqueue_script('waitforimages', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.waitforimages.js', [ 'jquery' ], false, true);
        wp_enqueue_script('prettyphoto', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.prettyPhoto.js', [ 'jquery' ], false, true);
        wp_enqueue_script('jquery-easing', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.easing.1.3.js', [ 'jquery' ], false, true);
        wp_enqueue_script('isotope', MIKADO_ASSETS_ROOT . '/js/modules/plugins/isotope.pkgd.min.js', [ 'jquery' ], false, true);
        ...
        if (wilmer_mikado_is_page_smooth_scroll_enabled()) {
            wp_enqueue_script('tweenLite', MIKADO_ASSETS_ROOT . '/js/modules/plugins/TweenLite.min.js', [ 'jquery' ], false, true);
            wp_enqueue_script('smoothPageScroll', MIKADO_ASSETS_ROOT . '/js/modules/plugins/smoothPageScroll.js', [ 'jquery' ], false, true);
        }

        //include google map api script
        $google_maps_api_key = wilmer_mikado_options()->getOptionValue('google_maps_api_key');
        $google_maps_extensions = '';
        $google_maps_extensions_array = apply_filters('wilmer_mikado_filter_google_maps_extensions_array', []);
        ...
        if (! empty($google_maps_api_key)) {
            wp_enqueue_script('wilmer-mikado-google-map-api', '//maps.googleapis.com/maps/api/js?key=' . esc_attr($google_maps_api_key) . $google_maps_extensions, [], false, true);
            if (! empty($google_maps_extensions_array) && is_array($google_maps_extensions_array)) {
                wp_enqueue_script('geocomplete', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.geocomplete.min.js', ['jquery', 'wilmer-mikado-google-map-api'], false, true);
            }
        }

        wp_enqueue_script('wilmer-mikado-modules', MIKADO_ASSETS_ROOT . '/js/modules.min.js', [ 'jquery' ], false, true);
...
if (! function_exists('wilmer_mikado_theme_setup')) {
    ...
    function wilmer_mikado_theme_setup()
    {
        ...
        add_theme_support('post-formats', [ 'gallery', 'link', 'quote', 'video', 'audio' ]);
...
if (! function_exists('wilmer_mikado_get_global_variables')) {
    ...
    function wilmer_mikado_get_global_variables()
    {
        ...
        wp_localize_script('wilmer-mikado-modules', 'mkdfGlobalVars', [
...
if (! function_exists('wilmer_mikado_per_page_js_variables')) {
    ...
    {
        $per_page_js_vars = apply_filters('wilmer_mikado_filter_per_page_js_vars', []);

        wp_localize_script('wilmer-mikado-modules', 'mkdfPerPageVars', [
...
if (! function_exists('wilmer_mikado_content_elem_style_attr')) {
    ...
    {
        $styles = apply_filters('wilmer_mikado_filter_content_elem_style_attr', []);
    ...
    function acf_home_hero()
    {
        ...
        if(function_exists('acf_register_block')) {
            ...
            acf_register_block([
                ...
                'description' => __('Hero Slider gallery'),
                'render_template' => 'template-parts/blocks/block-hero-slider.php',
                'category' => 'layout',
                'icon' => 'excerpt-view',
                'keywords' => [ 'portfolio' ],
            ]);
