...
if ( ! function_exists( 'wilmer_mikado_get_hide_dep_for_header_main_menu_options' ) ) {
	function wilmer_mikado_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'wilmer_mikado_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'wilmer_mikado_header_main_navigation_options_map' ) ) {
	function wilmer_mikado_header_main_navigation_options_map() {
		$hide_dep_options = wilmer_mikado_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = wilmer_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'wilmer' ),
		...
		wilmer_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'wilmer' )
			)
		);
		...
		$drop_down_group = wilmer_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'wilmer' )
			)
		);
		
		$drop_down_row1 = wilmer_mikado_add_admin_row(
			array(
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'wilmer' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'wilmer' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'wilmer' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'wilmer' )
				)
			)
		);
		...
		$first_level_group = wilmer_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'wilmer' )
			)
		);
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'wilmer' ),
			)
		);
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'wilmer' ),
			)
		);
		
		$first_level_row4 = wilmer_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'wilmer' ),
			)
		);
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'wilmer' ),
			)
		);
		
		$first_level_row5 = wilmer_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = wilmer_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = wilmer_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'wilmer' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'wilmer' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = wilmer_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'wilmer' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'wilmer' )
			)
		);
		...
		$second_level_wide_group = wilmer_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'wilmer' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'wilmer' )
			)
		);
		
		$second_level_wide_row1 = wilmer_mikado_add_admin_row(
			array(
		...
		$second_level_wide_row2 = wilmer_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = wilmer_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = wilmer_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'wilmer' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'wilmer' )
			)
		);
		...
		$third_level_wide_group = wilmer_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'wilmer' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'wilmer' )
			)
		);
		
		$third_level_wide_row1 = wilmer_mikado_add_admin_row(
			array(
		...
		$third_level_wide_row2 = wilmer_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = wilmer_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'wilmer_mikado_action_header_main_navigation_options_map', 'wilmer_mikado_header_main_navigation_options_map', 10, 1 );
}