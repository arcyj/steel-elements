...
if ( ! function_exists( 'wilmer_mikado_add_ion_icon_pack' ) ) {
	function wilmer_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new WilmerMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_collection', 'wilmer_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'wilmer_mikado_add_ion_icon_pack_option' ) ) {
	function wilmer_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'wilmer' );
		
		return $options;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_options', 'wilmer_mikado_add_ion_icon_pack_option' );
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_social_options', 'wilmer_mikado_add_ion_icon_pack_option' );
}

class WilmerMikadoClassIonIcons implements iWilmerMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	public function setIconsArray() {
		$this->icons = array(
			...
			'ion-android-wilmertop' => 'ion-android-wilmertop',
