...
if ( ! function_exists( 'wilmer_mikado_add_simple_line_icon_pack' ) ) {
	function wilmer_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new WilmerMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_collection', 'wilmer_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'wilmer_mikado_add_simple_line_icon_pack_option' ) ) {
	function wilmer_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'wilmer' );
		
		return $options;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_options', 'wilmer_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_social_options', 'wilmer_mikado_add_simple_line_icon_pack_option' );
}

class WilmerMikadoClassSimpleLineIcons implements iWilmerMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'wilmer'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'wilmer'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'wilmer'),
            'icon-social-facebook'    => esc_html__('Facebook', 'wilmer'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'wilmer'),
            'icon-social-github'      => esc_html__('Github', 'wilmer'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'wilmer'),
            'icon-social-instagram'   => esc_html__('Instagram', 'wilmer'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'wilmer'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'wilmer'),
            'icon-social-reddit'      => esc_html__('Reddit', 'wilmer'),
            'icon-social-skype'       => esc_html__('Skype', 'wilmer'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'wilmer'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'wilmer'),
            'icon-social-spotify'     => esc_html__('Spotify', 'wilmer'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'wilmer'),
            'icon-social-twitter'     => esc_html__('Twitter', 'wilmer'),
            'icon-social-youtube'     => esc_html__('Youtube', 'wilmer')
        );
    }
