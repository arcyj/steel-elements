...
if ( ! function_exists( 'wilmer_mikado_add_linea_icon_pack' ) ) {
	function wilmer_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new WilmerMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_collection', 'wilmer_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'wilmer_mikado_add_linea_icon_pack_option' ) ) {
	function wilmer_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'wilmer' );
		
		return $options;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_options', 'wilmer_mikado_add_linea_icon_pack_option' );
}

class WilmerMikadoClassLineaIcons implements iWilmerMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
