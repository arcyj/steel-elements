...
if ( ! function_exists( 'wilmer_mikado_add_font_awesome_icon_pack' ) ) {
	function wilmer_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new WilmerMikadoClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_collection', 'wilmer_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'wilmer_mikado_add_font_awesome_icon_pack_option' ) ) {
	function wilmer_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'wilmer' );
		
		return $options;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_options', 'wilmer_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_social_options', 'wilmer_mikado_add_font_awesome_icon_pack_option' );
}

class WilmerMikadoClassIconsFontAwesome implements iWilmerMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
