...
if ( ! function_exists( 'wilmer_mikado_add_linear_icon_pack' ) ) {
	function wilmer_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new WilmerMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_collection', 'wilmer_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'wilmer_mikado_add_linear_icon_pack_option' ) ) {
	function wilmer_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'wilmer' );
		
		return $options;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_options', 'wilmer_mikado_add_linear_icon_pack_option' );
}

class WilmerMikadoClassLinearIcons implements iWilmerMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
