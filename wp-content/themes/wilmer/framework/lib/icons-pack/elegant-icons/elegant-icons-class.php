...
if ( ! function_exists( 'wilmer_mikado_add_font_elegant_icon_pack' ) ) {
	function wilmer_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new WilmerMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_collection', 'wilmer_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'wilmer_mikado_add_font_elegant_icon_pack_option' ) ) {
	function wilmer_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'wilmer' );
		
		return $options;
	}
	
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_options', 'wilmer_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'wilmer_mikado_filter_add_icon_pack_into_social_options', 'wilmer_mikado_add_font_elegant_icon_pack_option' );
}

class WilmerMikadoClassIconsFontElegant implements iWilmerMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
